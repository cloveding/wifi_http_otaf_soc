...
void slx_ml_jlink_stream_internal_init(uint32_t *trigger_address_ptr, uint32_t *trigger_value_ptr, uint32_t context_address)
{
 ...
 /***************************************************************************//**
 *  Internal driver function to set interrupt
 ******************************************************************************/
void slx_ml_jlink_stream_set_interrupt_enabled(bool enabled)
{
 ...
 /***************************************************************************//**
 * This interrupt is triggered from an external script. The script uses the ARM NVIC
 *  software interrupt (NVIC->STIR) register to trigger this interrupt.
 ******************************************************************************/
