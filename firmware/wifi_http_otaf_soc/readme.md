...
1. Sign into the Amazon S3 console at [https://console.aws.amazon.com/s3/](https://console.aws.amazon.com/s3/).
...
12. Restart Apache Service
    ...
    - Our access resource URL looks as shown in following:
      ...
      > For example:
      >
      > - [http://192.168.1.4/Firmware/firmware.rps](http://192.168.1.4/Firmware/firmware.rps)
